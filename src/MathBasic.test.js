...
describe('A subtract function', () => {
  ...
  it('should return a - b when given two number parameters', () => {
    ...
    expect(MathBasic.subtract(8, 16)).toEqual(-8);
    expect(MathBasic.subtract(200, 1)).toEqual(199);
  });
});
...
describe('A multiply function', () => {
  ...
  it('should return a * b when given two number parameters', () => {
    ...
    expect(MathBasic.multiply(200, -2)).toEqual(-400);
  });
});
...
describe('A divide function', () => {
  ...
  it('should return a / b when given two number parameters', () => {
    ...
    expect(MathBasic.divide(200, -2)).toEqual(-100);
  });
});
